...
- Add enableSecurityInstructions option which defaults to true

### Changed
- Upgrade Suntory to 1.3.0
- Rename mandatory instructions to security instructions

## 1.2.1 - 2026-06-08
### Fixed
- Fix OpenAI API client passing to moderator
- Fix untrapped OpenAI Error on message moderation
- Fix integration fixture package linking to always use local repository build
...
- Add cooldown period support to prevent abuse
