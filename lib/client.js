...
class Client {
  constructor(apiKey, opts) {
    ...
    this.opts = {
      ...
      logprobs: opts.logprobs ?? true,
      topLogprobs: opts.topLogprobs ?? 3,
  ...
  async chat(memory, player, message) {
    ...
    const params = {
      ...
      logprobs: this.opts.logprobs,
      top_logprobs: this.opts.logprobs === true ? this.opts.topLogprobs : undefined,
